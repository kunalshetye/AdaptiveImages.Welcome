...
namespace AdaptiveImages.Welcome.REST.Media
{
    public class ArticleItem : BaseRestItem, IPublicWelcomeUrl
    {
        ...
        [JsonProperty("meta_url")] public string MetaUrl { get; set; }

        [JsonProperty("meta_keywords")] public List<string> MetaKeywords { get; set; } = new();

        [JsonProperty("source_article")] public string SourceArticle { get; set; }

        [JsonProperty("authors")] public List<Author> Authors { get; set; } = new();

        [JsonProperty("lang_code")] public string LangCode { get; set; }

        [JsonProperty("pixel_key")] public string PixelKey { get; set; }
