...
namespace AdaptiveImages.Welcome.REST.Media
{
    public abstract class BaseRestItem
    {
        ...
        [JsonProperty("title")] public virtual string Title { get; set; }

        [JsonProperty("created_at")] public DateTime CreatedAt { get; set; }

        [JsonProperty("modified_at")] public DateTime ModifiedAt { get; set; }

        [JsonProperty("labels")] public List<Label> Labels { get; set; }

        [JsonProperty("folder_id")] public Guid? FolderId { get; set; }

        [JsonProperty("file_location")] public string FileLocation { get; set; }
